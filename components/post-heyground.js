    ...
    <div className="row">
      ...
      <div className="col-xs-12 col-sm-7 col-md-8 col-lg-6">
        <div className="text-align-justify">
          <h4>
            The Space planning and program for the 1st floor in Creative office
            building.
          </h4>
          <p>
    ...
    <div className="row">
      ...
      <div className="col-xs-12 col-sm-12 col-md-6 col-lg-5">
        ...
        <p className="pr-3">
          ...
          <br />
          <br />
          ☀︎ : 가로변에서 카페와 바로 이어진 입구로 멤버쉽과 비멤버쉽을 한꺼번에
          유입하는 attraction 공간. 헤이 그라운드 오피스 공간은 입주자에게만
          열려있는 공간으로 대부분의 간단한 미팅은 1층 로비의 카페 '영춘'에서
          자연스럽게 이루어진다.
          <br />
      ...
      <div className="col-xs-12 col-sm-12 col-md-6 col-lg-5">
        ...
        <p>
          ...
          <br />
          <br />
          레스토랑과 카페를 구분짓는 낮은 소파가 공간을 구획하면서도 공간 규모가
          확장되어야 할 상황까지 함께 아우른다. 공간을 좀 더 구분지어야 할 때엔
          커튼을 이용.
        </p>
        <br />
      </div>
