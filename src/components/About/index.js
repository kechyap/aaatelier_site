...
const About = () => (
  <div className='About'>
    ...
    <Grid fluid>
      ...
      <Row>
        <Col xs={12} sm={6}>
          <h2 style={{paddingTop: '2rem', paddingLeft: '1.5rem', paddingRight: '1rem', color: 'rgb(230,130,130)'}}>
      ...
      <Row>
        ...
        <Col lg={1} />
        <Col xs={12}>
          <h2 style={{paddingLeft: '1.5rem', color: 'rgb(250,150,150)'}}> Ready for your concern </h2>
        </Col>
      ...
      <Row>
        <Col xs={12} sm={3} lg={4}>
          <h4 style={{paddingLeft: '1.5rem'}}> SOCIAL ISSUE </h4>
        </Col>
      ...
      <Row>
        <Col xs={12} lg={11} >
          <div className='tag'>
            #human #future #lifestyle
            #common space #community #co living #shared house #residential #co working #office #residence
            #environment issue #upcycle #urban issue #gentrification #public space #POPS
          </div>
        </Col>
        <Col lg={1} />
      </Row>
