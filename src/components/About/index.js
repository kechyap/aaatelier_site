            ...
            <Row className='py-3'>
              <Col xs={12} sm={12} md={6} lg={5}>
                ...
                >
                  ...
                  브랜드의 가치와 철학은 평면 작업에서부터 시작하여, 구조, 평면,
                  마감재, 작은 소품까지 모든 시각 언어로 사용자의 경험을
                  디자인합니다.
                </div>
              ...
              <Col xs={12} sm={12} md={5} mdOffset={1} lg={6}>
                <div>
                  ...
                  <p className='text-align-justify'>
                    ...
                    Branding과 공간은 하나의 개성을 지니고 있는 한 생명이며, 각
                    개체가 가지고 있는 고유한 영혼이 곧 Brand의 Identity입니다.{' '}
                    <br />
                    <br />
                  </p>
                  ...
                  <p className='text-align-justify'>
                    마감재는 브랜드의 전체 분위기가 표면적으로 보여지는 부분이며
                    전체 color 및 pattern 마감재 비율을 고려하여 제안 드립니다.{' '}
                    <br /> <br />
                  </p>
                  ...
                  <p className='text-align-justify'>
                    ...
                    낼 수 있는 합리적인 마감재 선택을 제안 드립니다. <br />{' '}
                    <br />
                  </p>
            ...
            <Col xs={12} sm={8} lg={7}>
              <div className='text-align-justify pb-2'>
                <p>
                  ...
                  우리의 삶을 이해하고 본질적인 문제 추구에서부터 디자인 작업을
                  시작하여 좋은 그릇을 만드는 것이 목표입니다.
                </p>
              </div>
            </Col>
          </Row>
          ...
          <Row>
            <Col xs={12} lg={11}>
              <small>
                ...
                #environment issue #upcycle #urban issue #gentrification #public
                space #POPS <br />
                <br />
              </small>
            </Col>
