          ...
          <Col xs={10} xsOffset={1} sm={10} mdOffset={1}>
            ...
            <Row className='py-3'>
              <Col xs={12} sm={12} md={6} lg={5}>
                ...
                <div style={{color: 'var(--pink3)', textAlign: 'justify' , lineHeight: '2rem'}}>
              ...
              <Col xs={12} sm={12} md={5} mdOffset={1} lg={6} >
                <div>
                  ...
                  <p className='text-align-justify' >
                    AAAtelier의 작업 프로세스는 생명을 창조하는 것과 같습니다. Branding과 공간은 하나의 개성을 지니고 있는 한 생명이며, 각 개체가 가지고 있는 고유한 영혼이 곧 Brand의 Identity입니다.   <br/><br/>
                  </p>
                  ...
                  <p className='text-align-justify'>
                    모든 프로세스 중에서 평면 작업이 가장 중요하다고 볼 수 있습니다. Brand의 정의가 정해지면 Client와의 상담을 통해 Brand에 맞는 Structure 및 평면 구성을 Brand에 맞는 맞춤형으로 제안 드립니다.   <br/><br/>
                  </p>
                  ...
                  <p className='text-align-justify'>
                    마감재는 브랜드의 전체 분위기가 표면적으로 보여지는 부분이며 전체 color 및 pattern 마감재 비율을 고려하여 제안 드립니다.  <br/> <br/>
                  </p>
                  ...
                  <p className='text-align-justify'>
                    Project의 budget에 따라 Marble, Wood, Tile등 최고의 효과를 낼 수 있는 합리적인 마감재 선택을 제안 드립니다. <br/> <br/>
                  </p>
