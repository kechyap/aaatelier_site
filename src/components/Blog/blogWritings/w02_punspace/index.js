  ...
  <Grid fluid>
    ...
    <Row>
      ...
      <Col xs={12} sm={7} md={8} lg={6}>
        ...
        <Row>
          <Col xs={5} md={4}>
            <div className='scoreT'> Accesabiliy </div>
          </Col>

          <Col xs={7} md={8}>
            <div className='score'>
              <div className='skills bar1'> 1 </div>
            </div>
          </Col>
        </Row>
        ...
        <Row>
          <Col xs={5} md={4}>
            <div className='scoreT'> Internet speed </div>
          </Col>
          <Col xs={7} md={8}>
            <div className='score'>
              <div className='skills bar2'> 2 </div>
            </div>
          </Col>
        </Row>
        ...
        <Row>
          ...
          <Col xs={7} md={8}>
            <div className='score'>
              <div className='skills bar3'> 3 </div>
            </div>
          </Col>
        </Row>
        ...
        <Row>
          ...
          <Col xs={7} md={8}>
            <div className='score'>
              <div className='skills bar4'> 4 </div>
            </div>
          </Col>
        </Row>
        ...
        <Row>
          ...
          <Col xs={7} md={8}>
            <div className='score'>
              <div className='skills bar5'> 5 </div>
            </div>
          </Col>
        </Row>
