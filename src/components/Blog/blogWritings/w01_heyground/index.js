    ...
    <Row>
      ...
      <Col xs={12} sm={12} md={6} lg={5} className='no-pm'>
        ...
        <p>
         ...
         <br /><br />
        ☀︎ : 가로변에서 카페와 바로 이어진 입구로 멤버쉽과 비멤버쉽을 한꺼번에 유입하는 attraction 공간. 헤이 그라운드 오피스 공간은 입주자에게만 열려있는 공간으로, 대부분의 간단한 미팅은 1층 로비의 카페 '영춘'에서 자연스럽게 이루어진다. <br /> <br />
      ...
      <Col xs={12} sm={12} md={12} lg={10} className='no-pm'>
        ...
        <p>
         ...
         <br /> <br />
          ☀︎ : Main Entrance에서 들어오자마자 엘레베이터 벽면쪽에 설치된 대형 screen으로 건물의 아이덴티티 전달 및 입주 기업들의 홍보 등등의 정보 전달이 손쉽게 가능. <br /> <br />
         ☂︎ : 전체 건물 규모에 비해 단 두대의 엘레베이터 용량에 대한 문제 해결이 시급하다. 출퇴근길에 갑자기 몰려드는 코워커들에게 대체 가능한 수직동선이 필요할 듯. <br /><br />
        </p>
      </Col>
