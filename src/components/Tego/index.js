...
const project = {
  ...
  photos: [
    ...
    { filename: 'menu5.svg', break: { xs: 12, sm: 12, md: 12, lg: 12, xl: 10 } },
    ...
    { filename: 'menu6.svg', break: { xs: 12, sm: 12, md: 12, lg: 12, xl: 10 } },
