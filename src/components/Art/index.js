...
const Art = () => (
  <div className='Art'>
      ...
      <Row>
        ...
        <Col xs={12} sm={7} md={8} lg={7} style={{ paddingTop: '1.3rem' }}>
          ...
          <p>
            ...
            on logical theory and data analysis. To set a logical goal in the
            beginning is one of the most important part of the project, but I
            believe that you can find out the artistic-freedom-spots easily
            after setting strict rules.
          </p>
          ...
          <p>
            ...
            <br />
            From this experience, I believe that if I want to achive new skills,
            practicing by yourself is not difficult. If you enjoy your work like
            a game, you will love to repeat practicing and finally anyone can
            reach the goal in the end.
            <br />
            <br />
          </p>
        </Col>
    ...
    <Grid fluid className='no-pm'>
      <Row>
        <Col xs={12} sm={12} md={12} lg={12} className='no-pm'>
          <img
